function(e1){"use strict";var
ae="*",bj="term computed",br="plugins/nsatz/polynom.ml",bi="+",bh="@[%s@]",p=250,aM="(",J="setoid_ring",bl="+ ",bq="Init",bg="...",i=246,bp="h",aJ=" ",aK=113,bn=477,af="1",be="nsatz_compute",bf="print_pol dans dansideal",bo=")*",ad="plugins/nsatz/nsatz.ml",bk="c",B="",an="^",I="Ring_polynom",H="0",aL=248,bm="u",L="\n",u="CC",q=e1.jsoo_runtime,f=q.caml_check_bound,aH=q.caml_equal,bc=q.caml_fresh_oo_id,aG=q.caml_int_compare,bd=q.caml_int_of_string,e0=q.caml_list_of_js_array,x=q.caml_make_vect,b=q.caml_new_string,o=q.caml_obj_tag,R=q.caml_register_global,ab=q.caml_string_equal,ac=q.caml_string_notequal,bb=q.caml_trampoline,aF=q.caml_trampoline_return,z=q.caml_wrap_exception;function
...
k=q.caml_get_global_data(),aw=[0,0,0],C=[0,0],N=[0,1],U=[0,2],aA=[0,b(bq),[0,b("Datatypes"),0]],E=[0,b("Numbers"),[0,b("BinNums"),0]],aE=b("nsatz_plugin"),T=k.CErrors,ap=k.Stdlib__array,g=k.Stdlib__list,d=k.Stdlib,S=k.Flags,ag=k.Pp,aN=k.Feedback,ao=k.Stdlib__format,e=k.Util,K=k.Assert_failure,aq=k.Failure,aP=k.Stdlib__char,D=k.Stdlib__hashtbl,av=k.CList,M=k.Stdlib__printf,aV=k.Heap,aj=k.Not_found,au=k.Stdlib__string,m=k.Num,n=k.CamlinternalLazy,w=k.Constr,a$=k.EConstr,a9=k.Unix,y=k.Big_int,ax=k.Ratio,by=b(L),bv=[0,[18,[1,[0,0,b(B)]],[2,0,[12,10,[17,0,0]]]],b("@[%s\n@]")],bt=[0,[18,[1,[0,0,b(B)]],[2,0,[17,0,0]]],b(bh)],bG=[0,b(br),365,43],b5=b(bg),bI=b(")"),bJ=b(aM),bK=b(B),bL=b(B),bM=b(H),b3=b(bg),b4=b(bi),bO=b(B),bP=b(H),bQ=b(af),bS=b(bo),bT=b(aM),bU=b(ae),bV=b(H),bW=b(af),bX=b(an),bY=b(an),bZ=b(bo),b0=b(aM),b1=b(an),b2=b(ae),bR=b(bi),bN=b(H),b_=b("div_pol1"),b$=[0,b(br),bn,9],ca=b(L),cb=b("x:"),cc=b(L),cd=b("r:"),ce=b(L),cf=b("q:"),cg=b(L),ch=b("p:"),ci=b("div_pol:\n"),b8=b(L),b7=b("\n{ "),b9=b("}"),b6=[0,[18,[1,[0,0,b(B)]],[2,0,[17,0,0]]],b(bh)],bH=b(bm),bF=b("non"),bD=[0,0],bE=[0,1],c8=b(L),c7=b(B),c9=b("lp:\n"),c6=b("p: "),c5=b("homogeneous polynomials"),c_=b("computed"),c2=b("new polynomial: "),c1=b(bk),c4=b(bp),c3=b(H),c0=b("computation of the Groebner basis"),cZ=b("coefficient: "),cY=b("verif sum: "),cX=b("r: "),cU=b("remainder: "),cV=b("polynomial reduced to 0"),cW=b("r ok"),cS=[0,[12,91,[4,3,0,0,[12,44,[4,3,0,0,[12,93,0]]]]],b("[%i,%i]")],cR=[0,0,0],cP=b(" terms"),cQ=b(" + "),cO=b(bf),cN=b(bf),cy=b(H),cz=b(af),cA=b(an),ct=b(ae),cu=b(ae),cv=b(ae),cw=b(af),cx=b(B),cB=b("-1"),cC=b(H),cD=b(af),cG=b(bl),cH=b(B),cI=b(aJ),cJ=b("-"),cE=b("- "),cF=b(bl),cK=b(H),cL=b(B),cM=b(aJ),cs=b(aJ),cq=b(" i="),cr=b("lv= "),co=b("]"),cp=b("["),cm=[0,0],cn=[0,1],cT=b("Ideal.Make(P).NotInIdealUpdate"),cj=b("Ideal.NotInIdeal"),ed=[0,b(ad),aL,9],eL=b("nsatz cannot solve this problem"),eH=b("eq_refl"),eI=[0,b(bq),[0,b("Logic"),0]],eJ=b(u),eF=b(bj),es=[0,[11,b("number of parameters: "),[4,3,0,0,0]],b("number of parameters: %i")],ep=[0,[12,120,[4,3,0,0,0]],b("x%i")],eo=b("nsatz: bad parameter"),ew=b("computation without sugar"),ex=b("computation with sugar"),ey=b("ordre lexico computation without sugar"),ez=b("ordre lexico computation with sugar"),eA=b("computation without sugar, division by pairs"),eB=b("computation with sugar, division by pairs"),eC=b("ordre lexico computation without sugar, division by pairs"),eD=b("ordre lexico computation with sugar, division by pairs"),eq=e0([b("a"),b("b"),b(bk),b("d"),b("e"),b("f"),b("g"),b(bp),b("i"),b("j"),b("k"),b("l"),b("m"),b("n"),b("o"),b("p"),b("q"),b("r"),b("s"),b("t"),b(bm),b("v"),b("w"),b("x"),b("y"),b("z")]),er=b("cert ok"),et=b(bj),eu=[0,b(ad),489,11],ev=[0,b(ad),bn,14],en=[0,b(ad),506,8],em=[0,b(ad),444,11],el=[0,0,0],ek=[0,[11,b("time: "),[18,[1,[0,0,b(B)]],[8,0,[0,1,10],[0,3],[17,0,[12,115,0]]]]],b("time: @[%10.3f@]s")],ej=[0,[11,b("useful spolynomials: "),[4,3,0,0,[12,32,0]]],b("useful spolynomials: %i ")],ei=[0,[11,b("useless spolynomials: "),[4,3,0,0,0]],b("useless spolynomials: %i")],ef=[0,0,0],eg=[0,0,0],eh=b(H),ec=[0,0],d$=b("Npos"),ea=b(u),d9=b("N0"),d_=b(u),d7=b("xH"),d8=b(u),d5=b("xO"),d6=b(u),d2=b("xI"),d3=b(u),dZ=b("Zneg"),d0=b(u),dX=b("Zpos"),dY=b(u),dV=b("Z0"),dW=b(u),dT=b("Z"),dU=b(u),dR=b("cons"),dS=b(u),dP=b("nil"),dQ=b(u),dN=b("list"),dO=b(u),dK=b("PEpow"),dL=[0,b(J),[0,b(I),0]],dM=b(u),dH=b("PEopp"),dI=[0,b(J),[0,b(I),0]],dJ=b(u),dE=b("PEmul"),dF=[0,b(J),[0,b(I),0]],dG=b(u),dB=b("PEsub"),dC=[0,b(J),[0,b(I),0]],dD=b(u),dy=b("PEadd"),dz=[0,b(J),[0,b(I),0]],dA=b(u),dv=b("PEX"),dw=[0,b(J),[0,b(I),0]],dx=b(u),ds=b("PEc"),dt=[0,b(J),[0,b(I),0]],du=b(u),dp=b("PExpr"),dq=[0,b(J),[0,b(I),0]],dr=b(u),eP=b("$lt"),eW=b(be),eY=b(be),eK=k.Tactics,dm=k.Coqlib,dn=k.Universes,eM=k.Mltop,eQ=k.Names,eS=k.Stdarg,eT=k.Genarg,eV=k.Loc,eZ=k.Ltac_plugin;function
bs(b){return S[6][1]?(a(ao[aK],bt,b),c(d[52],d[28])):0}function
bu(b){return S[6][1]?(a(ao[aK],bv,b),c(d[52],d[28])):0}function
...
j=[0,bs,bu,bw,bx,bA,bz,aO,bB,bC,function(k,j,d,b,e){var
...
as(b){var
c=v(b);return a(ao[aK],b6,c)}function
ad(f){var
b=[0,b7];function
g(c){var
...
b=a[2],d=0;function
f(b,a){return a+S(b)|0}return l(e[19][18],f,b,d)}return[0,I,W,J,ai,ak,s,L,al,n,X,h,Y,u,w,p,M,N,Z,_,aj,$,o,am,t,O,y,m,P,A,q,an,B,Q,ap,ar,aa,ac,i,v,as,ad,at,F,r,au,av,aw,ax,ae,G,ay,C,af,ag,ah,S,c(D[25],[0,n,S])]}];R(203,ar,"Nsatz_plugin.Polynom");var
aQ=[aL,cj,bc(0)],aR=[0,0];function
...
y=c(e[17][102],R),S=[0,y,function(d){function
e(a){return a[1]}var
...
n=a(au[7],cu,g);return a(d[17],cv,n)}return i?cw:cx}function
k(i,j){var
z=i?0:1;if(z)return j?cK:cL;var
A=0,B=i?i[2]:c(d[3],cN),C=k(B,A),D=a(d[17],cM,C),m=i?i[1]:c(d[3],cO),h=m[2],n=c(b[39],m[1]),o=a(d[17],n,co),e=a(d[17],cp,o);if(ac(e,cB))if(ac(e,cC))if(ac(e,cD))if(45===q.caml_string_get(e,0))var
p=g(h,0),r=l(au[4],e,1,q.caml_ml_string_length(e)-1|0),s=a(d[17],r,p),f=a(d[17],cE,s);else
if(0===j)var
...
h=c(g[1],b),i=c(d[22],h),j=a(d[17],i,cP),k=a(d[17],cQ,j),l=p(e,[0,c(g[5],b),0]),f=a(d[17],l,k);else
var
...
w=[aL,cT,bc(0)];function
L(t,m,f,s,e,C){var
x=G(m,t[1],e),q=x[2],D=x[1];function
E(c){var
b=u(f,q);return a(d[17],cU,b)}c(j[5],E);var
y=[0,q,a(b[22],t[2],D)];if(q)throw[0,w,y];c(j[6],cV);function
F(a){return 0}var
H=a(g[17],F,e),i=y[2],z=I(m,o(i,s),e,H),A=z[1],J=z[2];c(j[6],cW);function
K(c){var
b=p(f,J);return a(d[17],cX,b)}c(j[5],K);function
L(k){function
b(c,b,a){return h(c,v(b,a[1]))}var
c=o(i,s),j=p(f,aI(g[25],b,c,A,e));return a(d[17],cY,j)}c(j[5],L);function
M(c){var
b=p(f,k(1,i));return a(d[17],cZ,b)}c(j[5],M);var
r=0,l=c(g[9],e);for(;;){if(l){var
B=l[2],N=l[1],O=function(b){return function(a){return $(m,b,a)}}(N),r=[0,a(g[17],O,B),r],l=B;continue}var
P=a(av[117],C,r),Q=function(a){return o(n(-1),a)};return[0,i,1,P,a(g[19],Q,A)]}}function
...
ad=N(k[1]);if(ad<N(p)){c(j[6],c4);var
h=[0,b,i];continue}}var
...
o=B}c(j[6],c_);return o},T]},aQ,aR];R(209,v,"Nsatz_plugin.Ideal");var
c$=c(y[36],0),aW=m[52],aX=y[24],aY=y[27],aZ=y[16],da=m[51],db=y[25],dc=y[4],dd=y[5],de=y[10],df=y[8],dg=y[3],dh=y[15],di=y[33];function
dj(a){try{var
b=c(y[38],a);return b}catch(a){a=z(a);if(a[1]===aq)return 1;throw a}}var
dk=y[19];function
dl(e,d){var
c=e,b=d;for(;;){if(a(aX,b,c$))return c;if(a(aY,c,b)){var
...
t(d,b,a){var
e=l(dm[2],d,b,a);return c(dn[50],e)}var
az=[i,function(a){return t(dr,dq,dp)}],O=[i,function(a){return t(du,dt,ds)}],V=[i,function(a){return t(dx,dw,dv)}],W=[i,function(a){return t(dA,dz,dy)}],X=[i,function(a){return t(dD,dC,dB)}],Y=[i,function(a){return t(dG,dF,dE)}],Z=[i,function(a){return t(dJ,dI,dH)}],_=[i,function(a){return t(dM,dL,dK)}],a3=[i,function(a){return t(dO,aA,dN)}],a4=[i,function(a){return t(dQ,aA,dP)}],a5=[i,function(a){return t(dS,aA,dR)}],h=[i,function(a){return t(dU,E,dT)}],ak=[i,function(a){return t(dW,E,dV)}],$=[i,function(a){return t(dY,E,dX)}],d1=[i,function(a){return t(d0,E,dZ)}],d4=[i,function(a){return t(d3,E,d2)}],aa=[i,function(a){return t(d6,E,d5)}],al=[i,function(a){return t(d8,E,d7)}],am=[i,function(a){return t(d_,E,d9)}],eb=[i,function(a){return t(ea,E,d$)}];function
r(a,d){var
...
d=o(ak);return p===d?ak[1]:i===d?c(n[2],ak):ak}return a(m[28],b,C)?r($,[0,P(b),0]):r(d1,[0,P(a(m[4],ec,b)),0])}function
F(A){var
b=A;for(;;)if(typeof
b==="number"){var
b=[0,C];continue}else
...
0:return 0;case
1:break;default:var
f=a[2],g=a7(a[3]);return[0,G(f),g]}}throw[0,K,ed]}function
ee(c,b){function
e(g,f){var
...
a8=c(ar[1],[0,aX,aY,db,dc,dd,de,df,dg,dh,aZ,dk,dl,dj,aW,di]),s=c(v[2],a8);function
aC(h,a){var
b=c(s[1],a);function
g(b){if(b){var
...
k=a[1],p=f(e,k)[k+1];return[0,a[1],p]}}return[0,d,g]},p=l(e[17][18],s,ef,b),h=p[2],a=p[1];if(0===a){var
i=function(a){if(0===a[0])return a0(c(da,a[1]));var
b=a[2],f=a[1];function
g(e,b,a){var
g=a1([0,[1,c(d[22],f)],e]);return ay([0,a,a2([0,i(b),g])])}return l(e[19][45],g,b,0)},j=i(r);return c(e[17][55],k)?j:ay([0,j,g(k)])}var
t=function(i,g){var
b=g[2],j=g[1],k=i[2],l=i[1];if(h<=f(c(v[1][1],b),a)[a+1]){var
m=c(v[1][1],b),d=c(e[19][8],m);d[a+1]=f(d,a)[a+1]-h|0;return[0,[0,[0,j,c(v[1][2],d)],l],k]}return[0,l,[0,[0,j,b],k]]},q=l(e[17][18],t,eg,b),u=q[2],w=q[1],x=1===h?[1,c(d[22],a)]:a1([0,[1,c(d[22],a)],h]),y=g(c(e[17][9],u));return ay([0,a2([0,x,g(c(e[17][9],w))]),y])}return a0(c(m[43],eh))}return g(b)}function
a_(b,a){function
...
eE(aw){var
u=a7(aw),g=l(e[17][18],ee,0,u);if(u){var
w=u[1];if(typeof
w==="number")var
d=0;else
if(0===w[0]){var
...
c=b[1],d=I(b[2]),e=d[2],f=d[1];if(!a(s[5],c,s[3]))if(!X(c))return[0,[0,c,f],[0,0,e]];return[0,f,[0,1,e]]}return el},J=I(ad),Q=J[2],ae=J[1],V=c(a9[90],0),t=aI(s[10],aa,g,ae,ac),W=function(d){var
b=c(a9[90],0)-V;return a(M[4],ek,b)};c(j[5],W);c(j[6],er);var
...
c=1-a(s[5],d,s[3]);return c?G((e+b|0)+1|0):c};return a(e[17][89],d,c)}return 0};G(0);var
R=function(b,c){function
d(a,d){if(k<=((b+a|0)+1|0))return 1;var
c=(b+a|0)+1|0;return f(q,c)[c+1]}return f(q,b)[b+1]?[0,a(e[17][81],d,c)]:0},b=a(av[73],R,D),S=function(f){var
d=k-c(e[17][1],b)|0;return a(M[4],ei,d)};c(j[5],S);var
U=function(f){var
d=c(e[17][1],b);return a(M[4],ej,d)};c(j[5],U);if(b){var
ah=b[2],ai=a_(Q,b[1]),ak=aC(g,a(s[2],g,t[1])),al=[6,0,t[2]],am=c(e[17][9],ah),an=function(a){return a_(Q,a)},ao=a(e[17][15],an,am),ap=function(a){return aC(g,a)},aq=c(e[17][15],ap),ar=a(e[17][15],aq,ao),as=function(a){return aC(g,a)},at=a(e[17][15],as,ai),au=function(b){return a(M[4],es,P)};c(j[5],au);c(j[6],et);var
...
q=[0,l(e[17][19],m,d,k),[0,b,0]];return r(a5,[0,aB(0),q])},aF=l(e[17][19],aE,aA,aD);c(j[6],eF);return aF}throw[0,K,eu]}throw[0,K,ev]}var
d=1,E=0}else
var
E=1;if(E)var
d=1}else
...
eG(a){var
b=[0,r(a3,[0,aB(0),0]),a],d=[0,t(eJ,eI,eH),b],e=c(w[13],d),f=[0,c(a$[8],e),0];return c(eK[146],f)}var
...
eR=c(eQ[1][7],eP),eU=[0,[5,c(eT[16],eS[13])],eR],eX=[0,[0,[0,eW,[1,a(eV[11],0,eU),0]],eO],eN];aI(eZ[10][8],aE,eY,0,eX);var
