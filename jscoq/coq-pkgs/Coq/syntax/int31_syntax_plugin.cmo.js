...
c=d.caml_get_global_data(),r=a("int31_syntax_plugin"),k=[0,a("Coq"),[0,a("Numbers"),[0,a("Cyclic"),[0,a(E),[0,a(E),0]]]]],w=a("int31_scope"),h=c.Bigint,f=c.DAst,s=c.Stdlib__list,g=c.Names,Q=c.Pp,S=c.CErrors,I=c.Globnames,H=c.Libnames,U=c.Notation;b(c.Mltop[10],r);var
