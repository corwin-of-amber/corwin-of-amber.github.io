...
g=b.caml_get_global_data(),t=a("string_syntax_plugin"),k=[0,a(D),[0,a(E),[0,a(s),0]]],h=g.DAst,m=g.CamlinternalLazy,y=g.Globnames,r=g.Stdlib__buffer,l=g.Ascii_syntax_plugin,K=g.Stdlib__char,H=g.Coqlib,P=g.Notation;c(g.Mltop[10],t);var
