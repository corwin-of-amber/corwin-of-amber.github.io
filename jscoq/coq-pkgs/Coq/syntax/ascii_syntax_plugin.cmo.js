...
a=b.caml_get_global_data(),q=c("ascii_syntax_plugin"),i=[0,c("Coq"),[0,c("Strings"),[0,c(L),0]]],h=a.Util,j=a.Coqlib,g=a.DAst,A=a.CamlinternalLazy,s=a.Globnames,l=a.Names,Z=a.Option,Y=a.Stdlib,X=a.Stdlib__printf,T=a.Pp,V=a.CErrors,N=a.Libnames,aa=a.Notation;d(a.Mltop[10],q);var
...
b=d(Y[18],a);return e(h[15][1],1,b)}return e(X[4],W,a)}function
E(a){var
