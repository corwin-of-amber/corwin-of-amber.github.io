...
lJ(e,b,d){var
a=d;for(;;){if(a){var
f=a[2];c(e,b,a[1]);c(l[55],b,lK);var
...
lM(b){return b?b[1]:a(l[3],lN)}function
lO(e,d){var
b=e;for(;;){if(b){var
...
if(!c)if(!b)return 0;return a(l[2],lS)}function
lT(g,f,e){var
...
b=e;continue}throw a}}return a(l[3],lV)}}}function
lW(g,b){function
d(b){if(b){var
e=b[2],f=b[1];return e?c(g,f,d(e)):f}return a(l[2],lX)}return d(b)}function
lY(e,d){var
a=[0,0,d];for(;;){var
...
c=c+1|0,b=f;continue}return a(l[3],l7)}return 0}}return e(0,c,b)}function
...
f=b[2],g=a(e,b[1])^c,b=f,c=g;continue}return c^a(bj[27],0)}}];function
mh(a){return a}function
mi(a){return a+1|0}var
g0=[0,mh,mi,function(d,b){var
e=a(l[22],b);return c(l[55],d,e)},Z],mj=a(d9[1],[0,g0[4]]);function
g1(a){for(;;)try{var
...
f=c(D[67],0,0),h=f[2],i=f[1],j=c(D[67],0,0),k=j[2],m=j[1],o=c(D[67],0,0),p=o[2],t=o[1],u=aT(D[69],b,s,i,k,p),q=a(D[31],h);c(l[61],q,r);a(l[52],q);var
d=g1(u);function
w(e){var
...
g=a(d_[1],c),h=e(n[4],mk,b,g);return a(l[3],h)}}var
j=e(n[4],ml,b,c);return a(l[3],j);case
1:var
k=e(n[4],mm,b,d[1]);return a(l[3],k);default:var
o=e(n[4],mn,b,d[1]);return a(l[3],o)}},w)}];aU(691,k,"Micromega_plugin.Mutils");function
...
f=l[8];function
g(e,d,a){var
f=G.caml_div(cE(e,b),d);return c(l[5],a,f)}var
...
d=b[1],g=b[2],h=d[1],i=[0,h,a(f[56],d[2])],c=c+a(bj[27],i)|0,b=g;continue}return a(bj[27],c)}}var
ou=0;function
ov(h,b){function
d(b){var
...
hR(d,c,b){if(b){var
f=b[2],g=b[1],h=g[2],e=g[1],i=Z(d,e)+1|0;if(2<i>>>0)return a(l[3],oC);switch(i){case
0:return bG(d,a(c,em),b);case
1:return bG(e,a(c,h),f);default:return[0,[0,e,h],hR(d,c,f)]}}return bG(d,a(c,em),0)}function
hS(d,c,b){if(b){var
f=b[2],g=b[1],e=g[1],h=Z(d,e)+1|0,i=g[2];if(2<h>>>0)return a(l[3],oD);switch(h){case
...
6:case
7:var
f=a[1],g=b0(a[2]),h=b0(f);return c(l[6],h,g);default:var
b=0}if(b){var
a=d;continue}return-1}}function
fB(a){if(typeof
a==="number")return-1;else{if(0===a[0]){var
b=a[2],d=a[1],f=fB(a[3]),h=b0(b),i=c(l[6],h,f);return c(l[6],d,i)}var
j=a[5],k=a[2],m=a[1],n=b0(a[4]),o=b0(k),p=c(l[6],o,n),q=c(l[6],m,p),r=function(b,a){var
d=fB(a);return c(l[6],b,d)};return e(g[20],r,q,j)}}function
a2(b,a){if(typeof
...
6:var
o=a[2],g=a2(b,a[1]),p=g[3],q=g[1],h=a2(g[2],o),r=h[2],s=[6,p,h[3]];return[0,c(l[26],h[1],q),r,s];case
7:var
t=a[2],i=a2(b,a[1]),u=i[3],v=i[1],j=a2(i[2],t),w=j[2],x=[7,u,j[3]];return[0,c(l[26],j[1],v),w,x];case
8:var
...
v=b[5],w=b[4],x=b[3],y=b[1],i=eo(f,fC(b[2])),z=i[3],A=i[2],B=i[1],j=eo(A,fC(w)),C=j[3],D=j[2],E=j[1],F=function(a){return fD(D,a)},G=c(g[17],F,v),n=a(g[46],G),H=n[2],I=n[1],J=c(l[26],E,B),K=[1,y,z,x,C,H],L=function(b,a){return[0,a[1],[8,a[2]],b]},M=e(g[20],L,K,J);return[0,e(g[20],l[6],0,I),M]}}function
o3(c,a){var
...
r=function(e){var
f=e[2],g=a(aG[8],e[1]),h=c(H[7],d,g),i=a(aG[7],h);return[0,i,c(bE,b,f)]},s=c(g[17],r,i),h=fF([0,c(l[26],j,s),pb])}var
...
g=e[1];if(b){var
i=b[1],h=c(f[29],g,a);return h?c(f[29],a,i):h}return c(f[29],g,a)}return b?c(f[29],a,b[1]):1}],aH=a(d9[1],[0,Z]),h0=p[7],aa=a(bj[25],[0,h0[1],h0[2]]),h1=[0,l[8]],b2=[aW,pp,aV(0)],po=0;function
pq(a){function
d(h,g){var
...
fH(d,b){if(b){var
e=a(f[40],b[1]);return c(l[55],d,e)}return c(l[55],d,pu)}function
h2(b,a){return C(n[1],b,pv,fH,a[1],fH,a[2])}function
pw(a,b){c(l[55],a,px);var
d=0;function
f(b,c){return e(n[1],a,py,b)}e(aH[15],f,b,d);return c(l[55],a,pz)}function
pA(a,b){c(l[55],a,pB);var
d=0;function
f(b,c){return e(n[1],a,pC,b)}e(aH[15],f,b,d);return c(l[55],a,pD)}function
pE(b,a){return h2(b,a[1])}function
h3(b,d){var
g=d[2],h=g[2],i=g[1],j=d[1];if(i){var
k=a(f[40],i[1]);e(n[1],b,pF,k)}c(p[7][4],b,j);if(h){var
m=a(f[40],h[1]);return e(n[1],b,pG,m)}return c(l[55],b,pH)}function
pI(b,a){function
...
h=d[2],i=d[1],j=a(f[25],g);if(0===j)return c(b1[6],d,e)?p2:a(l[3],p3);if(1===j){var
k=c(an,b,h);return[0,c(an,b,i),k]}var
m=c(an,b,i);return[0,c(an,b,h),m]}function
fL(g,f,b){function
d(j,i,h){var
b=h$(g,j),k=b[1],d=c(p[7][17],f,b[2]),m=d?d[1]:p6,n=ia(m,k,i[1][1]),e=c(b1[3],h,n);return e?e[1]:a(l[3],p5)}return e(aa[14],d,b,p4)}function
ib(d){var
e=d[1];if(e){var
...
i=0;function
j(d,b){var
e=a(p[7][18],b[1]);return c(l[1][5],d,e)}var
...
d=fM(l[8],fQ[6],fN[2],i);if(0===d[0]){var
...
q=h[1];if(q){var
r=fR(q[1][1],[0,p,w],[0,o,h]);return r?[1,r[1]]:a(l[3],qr)}return[1,[0,bo([0,p,qt],[0,o,qs]),h]]}return[0,[0,b,d]]}var
...
y=a[2],z=b(a[1]),A=b(y),f=ii(c(l[26],z,A));if(0===f[0]){var
...
t=c(g[17],s,b),u=[0,a(p[7][5],[0,[1,q[2]],t]),r,o],v=[0,u,ir(b)],w=c(l[26],v,n),x=[1,q[1]];return[0,[0,a(p[7][5],[0,[1,q[2]],0]),1,x],w]}var
qX=k[30][7];function
fS(d,b){var
...
o=[0,a(k[30][1],i)];return[4,[3,[5,a(g,e)],o],f]}return a(l[3],qY)}return 0};return ip(ex(d,h(i,f)))}return a(l[3],qZ)}var
...
g=a(d_[1],b);c(n[2],q3,g);a(l[52],l[28])}return 0}throw b}}function
iv(b){try{var
...
m(b){var
c=b[1],d=c[2],f=b[2],g=c[1];return 1===d?a(l[3],q7):[0,[0,cM(e,g),d],f]}return iw(c(g[17],m,j))}function
ix(c,b){try{var
e=q6(c,b);return e}catch(b){b=v(b);if(a(bn[20],b)){var
d=a(d_[1],b);a(l[31],d);return 0}throw b}}function
cN(e,b){var
d=a(g[1],e),f=c(l[6],b,eW(d,b));return c(l[6],d,f)}function
q8(d,b,a){var
...
w=e(g[20],v,u,t),h=c(l[26],f,w);function
...
G=e(aI[13],F,C,E),j=c(l[26],h,G);function
H(a){return a[1]}var
...
h=il(e,a(p[7][8],g)),i=a(k[17],c),j=a(k[30][7],i),m=a(k[18],c),n=a(k[30][7],m),o=[0,[2,[4,[0,j],h],[5,[0,n]]],iA(f)];return o}catch(b){b=v(b);if(b[1]===e_)return a(l[3],rk);throw b}}function
bJ(b){if(typeof
...
c=c+1|0,b=e;continue}return a(l[3],rp)}}function
...
8:var
h=b[1],r=h[1],s=a(k[30][3],h[2]);return[6,aJ(r),s];default:return a(l[3],rr)}}function
fW(b){var
...
8:var
i=b[1],t=i[1],u=a(k[30][3],i[2]);return[6,aK(t),u];default:return a(l[3],rx)}}function
fX(b){var
...
c=c+1|0,b=f;continue}return a(l[3],rB)}}];function
fY(b){var
...
0:case
1:var
e=c(iD[1],b[1],d);return[0,a(k[30][1],e)];default:return a(l[3],rD)}}function
cO(b,a){if(typeof
a==="number")return 0;else{if(0===a[0]){var
...
iE(e,b){var
f=1+a(p[15],b)|0,d=c(p[18],f,b)[2];if(B[4])x(n[1],l[28],rE,p[13],d);return cO(e,d)}function
eA(b){var
...
rH(d,b){var
e=a(f[40],b);return c(l[55],d,e)}function
rI(d,b){var
e=a(q[33],b);return c(l[55],d,e)}function
eB(g,f){var
e=0,d=g,b=f;for(;;){if(b){if(d){var
h=b[2],i=d[2],j=c(p[20],b[1],d[1]),e=c(p[19],j,e),d=i,b=h;continue}return a(l[3],rJ)}return e}}function
iF(d){var
b=a(g[46],d),e=b[2],c=eA(b[1]);return c?[0,eB(e,c[1])]:0}var
iG=B[4]?function(b){a(n[2],rK);a(l[52],l[28]);var
c=iF(b);a(n[2],rL);a(l[52],l[28]);return c}:iF;function
fZ(m){var
...
rQ(i,h){var
b=a(q[36],i),d=a(q[36],h),e=cQ(b,d),f=e[2],g=e[1],j=c(q[10],f,d),k=c(q[10],g,b),m=c(q[5],k,j),o=a(q[33],m),p=a(q[33],d),r=a(q[33],f),s=a(q[33],b),t=a(q[33],g);return d0(n[1],l[28],rR,t,s,r,p,o)}var
...
S=A[1],T=a(g[6],z[1]);return[0,[0,a(g[6],S),[0,m,j,i],T]]}return a(l[3],r5)}return 0}function
eE(b){function
d(b){var
d=b[1][1];function
e(b){return 0!==a(f[25],b[2])?1:0}return c(g[27],e,d)}return c(g[27],d,b)}function
f3(o,m,b){function
q(i,b){if(B[4]){a(n[2],r6);a(l[52],l[28])}if(eE(b)){var
...
var
A=function(b,a){var
d=a[1],e=b[1],f=d[1],g=e[1],h=[6,b[2],a[2]],i=c(p[10],e[2],d[2]);return[0,[0,c(p[6][6],g,f),i],h]},C=c(k[8],A,d),i=c(l[26],d,C);function
y(a){var
...
cR=[0,function(p){var
b=a(bj[25],p),k=[aW,si,aV(0)],f=[aW,sj,aV(0)];function
q(d,c){var
...
n(f){for(;;){var
a=s(i);if(a){var
c=a[1];e(b[10],d,c[1],c[2]);continue}return 0}}try{g(0,f,n);a(l[83],i);var
o=e(D[23],h,sp,eY),p=[0,a(D[31],o),1,d];return p}catch(f){f=v(f);if(f===k){a(l[83],i);var
m=e(D[23],h,sn,eY),j=a(D[31],m);g(1,m,function(g){function
f(b,a){return e(d$[1],j,[0,b,a],so)}c(b[12],f,d);return a(l[52],j)});return[0,j,1,d]}throw f}}function
w(c){var
d=c[1],e=c[3];return 0===c[2]?0:(a(l[65],d),a(b[2],e),c[2]=0,0)}function
n(c,i,h){var
d=c[1],j=c[3];if(0===c[2])throw f;var
k=a(D[33],d);e(b[10],j,i,h);return g(1,k,function(b){e(d$[1],d,[0,i,h],sq);return a(l[52],d)})}function
o(a,d){var
...
sr=0;function
ss(d,c,b){var
f=a(D[97],0)[1],g=a(c,b),h=a(D[97],0)[1]-f;e(n[2],st,d,h);a(l[52],l[28]);return g}var
eF=l[8],f5=[0,eF],eG=[0,1],f6=[0,eF];function
f7(a){return[0,eG[1],f6[1]]}function
eH(a){return f5[1]}function
iS(b,a){function
c(b){var
c=b?b[1]:eF;a[1]=c;return 0}function
d(b){return[0,a[1]]}return[0,0,e(g[21],l[17],b,su),b,d,c]}function
...
bq(d,b){if(typeof
b==="number")return 0===b?c(l[55],d,sD):c(l[55],d,sE);else
switch(b[0]){case
0:return c(l[55],d,sF);case
...
i(b,a){return c(l[26],b,a)}function
j(b,e){if(e){var
...
b=[0,e[1]]}else
var
b=[1,d];return 0===b[0]?[0,h,c(l[26],g,b[1])]:[0,[0,b[1],h],g]}},b=e(g[21],i,d,sN),o=b[1],p=c(l[26],k,b[2]);return[0,c(l[26],n,o),p]}return[0,eI,0]}function
f(O,N){var
...
R=c(l[26],n,q);return[0,i(o,r),R]}var
s=h(o,r),S=s[1],T=c(l[26],q,s[2]);return[0,S,c(l[26],n,T)];case
3:var
U=d[2],t=f(b,d[1]),u=t[2],v=t[1],w=f(b,U),x=w[2],y=w[1];if(b){var
z=h(v,y),V=z[1],W=c(l[26],x,z[2]);return[0,V,c(l[26],u,W)]}var
X=c(l[26],u,x);return[0,i(v,y),X];case
4:var
b=1-b,d=d[1];continue;default:var
Y=d[3],A=f(1-b,d[1]),B=A[2],C=A[1],D=f(b,Y),E=D[2],F=D[1];if(b){var
G=h(C,F),Z=G[1],_=c(l[26],E,G[2]);return[0,Z,c(l[26],B,_)]}var
$=c(l[26],B,E);return[0,i(C,F),$]}}return f(1,b)}var
...
sP=c(l[26],cT[6],f_),sQ=c(l[26],cT[5],sP),sR=c(l[26],[0,iU,0],sQ),iV=c(l[26],cT[7],sR);function
L(d,c,b){var
...
ja(d,b){var
e=a(k[29][3],b),f=a(l[22],e);return c(l[55],d,f)}function
vR(k,g,f,e,b){var
...
bd(b,a){if(typeof
a==="number")return 0===a?c(l[55],b,vU):c(l[55],b,vV);else
switch(a[0]){case
0:return c(l[55],b,vW);case
...
v=y(b,2)[3];return[0,0,y(b,1)[2],v]}}throw N}break}return a(l[3],wz)}function
jh(n,k){var
b=k[2],f=k[1],g=n[2],o=c(m[3],g,f);switch(o[0]){case
10:var
...
v=y(b,2)[3];return[0,0,y(b,1)[2],v]}}throw N}break}return a(l[3],wA)}function
ji(c,a){var
...
b(e,f){var
b=bL(d,f);if(typeof
b!=="number"&&1===b[0]){if(0===e[0])return[0,c(r[85],e[1],b)];a(l[31],wW);a(l[52],l[28]);throw N}return[6,e,a(r[12][15],b)]}function
...
f=c(o,g,[0,d[1],d[2]]),p=f[3],q=f[1],i=e(h,b,n,f[2]),r=i[1],j=e(h,b,i[2],p);return[0,[0,r,q,j[1]],j[2]]}return a(l[3],wX)}function
...
b=b[2];continue;case
3:var
e=b[1],f=dP(b[2]),g=dP(e);return c(l[26],g,f);case
4:var
h=b[1],i=dP(b[2]),j=dP(h);return c(l[26],j,i)}return 0}}function
...
a==="number"?c(l[55],b,xs):0===a[0]?x(n[1],b,xt,o[aX],a[1]):bO(n[1],b,xu,gk,a[1],o[aX],a[2],gk,a[3])}function
eQ(b){if(typeof
b==="number"){var
...
f=b[2],e=b[1];if(a(h,e))return[0,[0,e],c(l[26],d,f)];var
d=[0,e,d],b=f;continue}return[0,0,d]}}function
...
xK(d,a,b){c(l[55],a,xL);function
e(b){return x(n[1],a,xM,d,b)}c(g[15],e,b);return c(l[55],a,xN)}function
jJ(f,d,b){function
h(j,b,i){var
...
d=a(l[3],xO)}return c(g[38],d,e)}try{var
t=c(d[5],m,o),h=t}catch(b){b=v(b);if(!a(bn[20],b))throw b;var
p=function(a){return a[1]},q=c(g[17],p,e),r=[0,a(d[2],0),q],f=a(d[3],r),s=f?f[1]:a(l[3],xP),h=s}return h}var
...
b!=="number"&&5===b[0]){var
j=b[2],k=b[1],m=c[1],n=bg(c[3],b[3]);return[5,bg(m,k),j,n]}}return a(l[3],xQ)}var
...
c=b[2];return[0,a(m[10],b[1]),c]},af=c(g[17],ae,u),k=o[22],H=i(k),ag=0,ah=[0,s[4]],ai=j===H?k[1]:d===H?a(h[2],k):k,aj=[0,ab,[0,$,[0,jH(s,V,a(m[21],[0,ai,ah]),af,X),ag]]],ak=a(I[66][20],aj),am=c(o[ko],q,D),an=a(g[9],am),ao=function(a){return c(g[7],y,a[2]-1|0)},ap=c(g[17],ao,u),aq=c(l[26],an,ap),ar=c(I[66][3],ak,aJ),as=a(al[78],0),at=c(I[66][3],as,ar),au=[0,a(m[10],G),aq],av=a(m[34],au),aw=[0,a(al[45],av),0],ax=c(g[17],m[10],W),ay=[0,a(al[kl],ax),aw],az=[0,at,[0,a(I[66][20],ay),0]],aA=ac(G),aB=x(al[kx],1,xZ,aA,Z),J=c(I[66][19],aB,az);else
var
aC=a(bs[3],x0),J=c(I[66][4],0,aC);return J}catch(b){b=v(b);if(b===o[j_]){var
M=a(bs[3],xS);return c(I[66][4],0,M)}if(b===B[23]){var
N=a(bs[3],xT);return c(I[66][4],0,N)}if(b===eT){a(l[52],l[28]);var
O=c(l[17],xV,xU),P=c(l[17],xW,O),Q=c(l[17],xX,P),R=a(bs[3],Q);return c(I[66][4],0,R)}throw b}}return a(dX[66][9],b)}}function
jM(y,x,w){var
...
c=b[2];return[0,a(m[10],b[1]),c]},aq=[0,am,[0,aj,[0,jM($,c(g[17],ap,t),af),0]]],ar=a(I[66][20],aq),as=c(o[ko],p,E),at=a(g[9],as),au=function(a){return c(g[7],z,a[2]-1|0)},av=c(g[17],au,t),aw=c(l[26],at,av),ax=c(I[66][3],ar,aK),ay=a(al[78],0),az=c(I[66][3],ay,ax),aA=[0,a(m[10],J),aw],aB=a(m[34],aA),aC=[0,a(al[45],aB),0],aD=c(g[17],m[10],ad),aE=[0,a(al[kl],aD),aC],aF=[0,az,[0,a(I[66][20],aE),0]],aG=an(J),aH=x(al[kx],1,yc,aG,ah),K=c(I[66][19],aH,aF);else
var
aI=a(bs[3],yd),K=c(I[66][4],0,aI);return K}catch(b){b=v(b);if(b===o[j_]){var
S=a(bs[3],x7);return c(I[66][4],0,S)}if(b===B[23]){var
T=a(bs[3],x8);return c(I[66][4],0,T)}if(b===eT){a(l[52],l[28]);var
U=c(l[17],x_,x9),V=c(l[17],x$,U),W=c(l[17],ya,V),X=a(bs[3],W);return c(I[66][4],0,X)}throw b}}return a(dX[66][9],b)}}function
jN(d,c){var
b=a(d,c);return b?[0,[0,b[1],0]]:0}var
jO=a(cR[1],[0,V,bj[27]]),gr=a(yf[8],ye)?0:[d,function(a){throw eT}];function
jQ(o,n){var
f=i(gr);if(j!==f)if(d===f)a(h[2],gr);var
p=[0,yj,[0,yi,[0,c(l[17],yh,yg[36]),0]]],q=a(yk[3],0),m=e(g[20],yl[4],q,p),b=e(k[35],m,[0,m],[0,o,n]);return 0===b[0]?b[1]:a(l[3],b[1])}function
...
gt(f,b){var
d=gs(f,b);if(d){var
e=a(aB[51],d[1]);return c(r[111],b,e)?[0,e]:(a(l[31],yn),0)}return 0}function
jS(f,b){function
h(a){var
b=a[2];return[0,dZ(a[1]),b]}var
d=gs(f,c(g[17],h,b));if(d){var
e=a(aB[54],d[1]);return c(r[89],b,e)?[0,e]:(a(l[31],yo),a(l[52],l[28]),0)}return 0}function
ce(e,d,b){function
f(i,h){var
...
gu=a(cR[1],[0,V,bj[27]]),jT=a(cR[1],[0,V,bj[27]]);function
yp(a){var
