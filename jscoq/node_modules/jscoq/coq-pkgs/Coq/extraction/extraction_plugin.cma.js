...
kB=" :: ",bJ="module ",eq=";",ln="i",ci=",",kM="functor (",k$="expr:lambda",kz="JSON",gC="=",kA=".\n",c$="(",k_=") ->",gY=123,kL="Haskell",kK='Prelude.error "EXTRACTION OF UINT NOT IMPLEMENTED"',bq="_vendor+v8.11+64bit/coq/plugins/extraction/extract_env.ml",k9="Compilation of file ",et="]",gO="=>",gN="(* ",k8="Cannot mix yet user-given match and general patterns.",k7="Print",eE=122,gX="#else",eD=" ->",bo=248,k6="Coq.Init.Specif",k5="match ",eC="_vendor+v8.11+64bit/coq/plugins/extraction/haskell.ml",c8="_vendor+v8.11+64bit/coq/plugins/extraction/modutil.ml",gW="| ",kJ="Constant",kI="items",k4="if",cg="_vendor+v8.11+64bit/coq/plugins/extraction/ocaml.ml",ky="define ",kx="->",k3=": ",eB="UNUSED",lm="error",ao=" = ",ll="of",bl=121,ex="[",gM="'",k2="Close it and try again.",gV=108,C="Extraction",k1=104,kH="unsafeCoerce :: a -> b",bn="extraction",X="name",kG=133,kw=103,ep=120,k0=" : logical inductive",U="__",kZ=102,lk=522,kv="unit",gI="args",lj=" (* AXIOM TO BE REALIZED *)",gU="-- HUGS",c_="body",kF="case",a3="  ",lh="Any",li="do",ku=354,kt="struct",c7="end",gH="#endif",kY="Reset",gG=" *)",ew="module type ",kX="else",db="}",es="in",eA="type",gB="Coq_",a1="_vendor+v8.11+64bit/coq/plugins/extraction/mlutil.ml",kE='Prelude.error "EXTRACTION OF FLOAT NOT IMPLEMENTED"',a2=107,gT="module",lf=" }",lg="force",kW="match",gS=143,gL="#ifdef __GLASGOW_HASKELL__",c6="argnames",u="what",ks="for",c9=109,gR=126,gK="in ",bm="type ",aj="",le="then",kD="Obj.magic",gQ="let ",eo="and ",ai=" =",gF="Inline",kV="OCaml",en="sig",da="_vendor+v8.11+64bit/coq/plugins/extraction/table.ml",ld=" end",kU="with constructors : ",au=".",ez=" :",gP=".ml",kT="unsafeCoerce",kr="class",kS="Recursive",gE="Blacklist",gJ="Extract",lc="Scheme",ev="false",kq="let {",kp="Library",kR=106,W=" ",er="_vendor+v8.11+64bit/coq/plugins/extraction/scheme.ml",ch=")",gD="let",ko=" with",kQ=":",M="_vendor+v8.11+64bit/coq/plugins/extraction/extraction.ml",kP="let rec ",ey="value",ak="_vendor+v8.11+64bit/coq/plugins/extraction/common.ml",bp="_",kO="as",lb="singleton inductive, whose constructor was ",eu="true",la=308,kC=271,kN="_vendor+v8.11+64bit/coq/plugins/extraction/json.ml",F=D1.jsoo_runtime,i=F.caml_check_bound,bk=F.caml_fresh_oo_id,km=F.caml_int_compare,c5=F.caml_list_of_js_array,bI=F.caml_make_vect,cf=F.caml_ml_string_length,d=F.caml_new_string,ah=F.caml_register_global,$=F.caml_string_get,aN=F.caml_string_notequal,D0=F.caml_trampoline,gz=F.caml_trampoline_return,kn=F.caml_update_dummy,m=F.caml_wrap_exception;function
...
lp=d("get_nth_label: not enough MPdot"),ow=[0,d(da),765,11],on=d(" is not a valid argument number for "),oo=d(" for "),op=d("No argument "),od=d(a3),ob=d(a3),oc=d("Extraction NoInline:"),oe=d("Extraction Inline:"),ny=d(C),nz=d("Extraction "),nw=d(" has been created by extraction."),nx=d("The file "),nu=d(" first."),nv=d("Please load library "),nn=d("but this code is potentially unsafe, please review it manually."),no=d("Extraction SafeImplicits is unset, extracting nonetheless,"),np=d(au),nq=d("At least an implicit occurs after extraction : "),nh=d("the extraction of unsafe code and review it manually."),ni=d("You might also try Unset Extraction SafeImplicits to force"),nj=d("Please check your Extraction Implicit declarations."),nk=d(au),nl=d("An implicit occurs after extraction : "),nb=d(aj),nc=d(") "),nd=d(c$),ng=d(aj),ne=d("of "),nf=d(" argument "),m3=d("asked"),na=d("required"),m4=d("extract some objects of this module or\n"),m$=d(aj),m5=d("use (Recursive) Extraction Library instead.\n"),m6=d("Please "),m7=d("Monolithic Extraction cannot deal with this situation.\n"),m8=d(kA),m9=d(".v as a module is "),m_=d("Extraction of file "),m0=d("Use Recursive Extraction to get the whole environment."),m1=d("For example, it may be inside an applied functor.\n"),m2=d(" is not directly visible.\n"),mZ=d("No Scheme modular extraction available yet."),mX=d("not found."),mY=d("Module"),mN=d(" (or in its mutual block)"),mO=d(gK),mP=d("or extract to Haskell."),mQ=d("Instead, use a sort-monomorphic type such as (True /\\ True)\n"),mR=d("The Ocaml extraction cannot handle this situation yet.\n"),mS=d("has logical parameters, such as (I,I) : (True * True) : Prop.\n"),mT=d("This happens when a sort-polymorphic singleton inductive type\n"),mU=d(au),mV=d(" has a Prop instance"),mW=d("The informative inductive type "),mJ=d("This situation is currently unsupported by the extraction."),mK=d("some Declare Module outside any Module Type.\n"),mL=d(" has no body, it probably comes from\n"),mM=d("The module "),mF=d("This is not supported yet. Please do some renaming first."),mG=d(" have the same ML name.\n"),mH=d(" and "),mI=d("The Coq modules "),mE=d("Not the right number of constructors."),mD=d("is not an inductive type."),mC=d(" is not a constant."),mx=d(" contains __ which is reserved for the extraction"),my=d("The identifier "),mu=d(k2),mv=d("You can't do that within a section."),ms=d(k2),mt=d("You can't do that within a Module Type."),mn=d("In case of problem, close it first."),mo=d("Extraction inside an opened module is experimental."),mj=d(" type variable(s)."),mk=d("needs "),ml=d("The type scheme axiom "),ma=d("fully qualified name."),mb=d("First choice is assumed, for the second one please use "),mc=d(" ?"),md=d(" or object "),me=d("do you mean module "),mf=d(" is ambiguous, "),mg=d("The name "),l4=d('If necessary, use "Set Extraction AccessOpaque" to change this.'),l5=d(au),l6=d("the following opaque constants have been extracted as axioms :"),l7=d("The extraction now honors the opacity constraints by default, "),lX=d(au),lY=d("the following opaque constant bodies have been accessed :"),lZ=d("The extraction is currently set to bypass opacity, "),lM=d("axiom was"),lS=d("axioms were"),lN=d("may lead to incorrect or non-terminating ML terms."),lO=d("Having invalid logical axiom in the environment when extracting"),lP=d(kA),lQ=d(" encountered:"),lR=d("The following logical "),lD=d("axiom"),lH=d("axioms"),lE=d(au),lF=d(" must be realized in the extracted code:"),lG=d("The following "),lB=[0,d(C)],lA=d(au),lx=[0,d(da),293,11],ly=d(au),lw=d("Inductive object unknown to extraction and not globally visible."),ls=d("_rec"),lt=d("_rect"),lr=[0,d(da),170,11],lq=[0,d(da),157,11],lo=[0,d(da),60,9],lI=d(bn),lJ=d("extraction-axiom-to-realize"),lT=d(bn),lU=d("extraction-logical-axiom"),l0=d(bn),l1=d("extraction-opaque-accessed"),l8=d(bn),l9=d("extraction-opaque-as-axiom"),mh=d(bn),mi=d("extraction-ambiguous-name"),mp=d(bn),mq=d("extraction-inside-module"),mz=d(bn),mA=d("extraction-reserved-identifier"),nr=d(bn),ns=d("extraction-remaining-implicit"),nA=d("AccessOpaque"),nB=d("AutoInline"),nC=d("TypeExpand"),nD=d("KeepSingleton"),nL=[0,d(C),[0,d("Optimize"),0]],nM=d("Extraction Optimize"),nP=[0,d(C),[0,d("Flag"),0]],nQ=d("Extraction Flag"),nT=[0,d(C),[0,d("Conservative"),[0,d("Types"),0]]],nU=d("Extraction Conservative Types"),nW=d(aj),nY=[0,d(C),[0,d("File"),[0,d("Comment"),0]]],nZ=d("Extraction File Comment"),n1=d("ExtrLang"),n4=d("Extraction Lang"),n7=d("ExtrInline"),n$=d("Extraction Inline"),oh=d("Reset Extraction Inline"),ok=d("SafeImplicits"),om=d("ExtrImplicit"),os=d("Extraction Implicit"),ov=d("ExtrBlacklist"),oz=d("Extraction Blacklist"),oE=d("Reset Extraction Blacklist"),oI=d("ExtrCustom"),oJ=d("ExtrCustomMatchs"),oM=d("ML extractions"),oQ=d("ML extractions custom matches"),ph=[0,d(a1),711,13],pu=[2,1],pv=[0,d(a1),1166,9],px=[0,1],pz=[0,1],pA=[0,1],pF=[0,d(a1),1511,56],pt=[0,d(a1),1048,10],pr=[0,[11,d("program_branch_"),[4,0,0,0,[10,0]]],d("program_branch_%d%!")],pf=[0,d(a1),702,13],pd=[0,d(a1),640,22],o$=[0,d(a1),352,18],o_=[0,d(a1),353,11],pa=[5,1],o9=[0,1],o2=[0,d(a1),168,4],oU=d("Extraction_plugin.Mlutil.Found"),oV=d("Extraction_plugin.Mlutil.Impossible"),oW=d("x"),oX=d(bp),pD=d("Extraction_plugin.Mlutil.Toplevel"),pH=[0,d("Coq.Init.Wf.well_founded_induction_type"),[0,d("Coq.Init.Wf.well_founded_induction"),[0,d("Coq.Init.Wf.Acc_iter"),[0,d("Coq.Init.Wf.Fix_F"),[0,d("Coq.Init.Wf.Fix"),[0,d("Coq.Init.Datatypes.andb"),[0,d("Coq.Init.Datatypes.orb"),[0,d("Coq.Init.Logic.eq_rec_r"),[0,d("Coq.Init.Logic.eq_rect_r"),[0,d("Coq.Init.Specif.proj1_sig"),0]]]]]]]]]],pS=d(aj),pT=[0,d(ak),101,10],qF=d(gM),qG=d(gM),qD=[0,d(ak),646,11],qE=[0,d(ak),648,49],qC=d("char"),qB=d("Prelude.Char"),qx=[0,d(ak),588,2],qv=d(bp),qu=d(au),qw=[0,d(ak),578,10],qt=[0,d(ak),549,10],qs=[0,d(ak),531,2],qr=[0,d(ak),lk,10],qq=[0,d(ak),518,5],qo=[0,d(aj),0],qn=d(aj),qj=[0,d(aj),0],qg=[0,d(ak),379,6],qf=[0,d(ak),380,6],qh=d(U),qi=d(aj),qc=d(aj),qd=d(bp),qe=d("Coq"),qb=d(gB),p_=d(gB),p$=d("coq_"),p9=d("Coq__"),p7=[0,d(ak),294,53],p6=[0,d(ak),282,14],p5=d("get_mpfiles_content"),pW=[0,d(ak),117,2],pX=d(gB),pR=d(W),pQ=d(ci),pP=d(ci),pO=d(ci),pM=d(W),pN=d(W),pK=d(ch),pL=d(c$),pU=d(au),pV=d(U),qy=d("ascii"),qz=d("Coq.Strings.Ascii"),qW=d('error "AXIOM TO BE REALIZED"'),qX=d(gQ),q0=[0,d(er),93,8],qY=d("`"),qZ=d("delay "),q1=d("Cannot handle tuples in Scheme yet."),q4=d("Cannot handle general patterns in Scheme yet."),q2=d(lg),q3=d(k5),q5=d(lm),q6=d(U),q7=d(kK),q8=d(kE),q9=d(ci),q_=[0,d(er),148,11],q$=d(W),ra=d(ch),rb=d(ch),rc=d("(("),rd=d("letrec "),rh=[0,d(er),217,29],rg=d(eB),rf=d(ky),re=d(ky),qV=d("@ "),qS=d("lambdas "),qT=d("lambda "),qU=[0,d(er),50,10],qN=d("(define __ (lambda (_) __))\n\n"),qO=d('(load "macros_extr.scm")\n\n'),qP=d(";; available at http://www.pps.univ-paris-diderot.fr/~letouzey/scheme\n"),qQ=d(";; This extracted scheme code relies on some additional macros\n"),qL=d(";; "),qI=c5([d("define"),d(gD),d("lambda"),d("lambdas"),d(kW),d("apply"),d("car"),d("cdr"),d(lm),d("delay"),d(lg),d(bp),d(U)]),rl=d(".scm"),rm=[0,d(c8),29,18],ro=[0,d(c8),210,9],rw=[9,d(eB)],rs=[0,d(c8),315,9],rq=[0,d(c8),234,29],rr=[0,d(c8),230,14],rp=d("reference not found in extracted structure."),rn=d("Extraction_plugin.Modutil.Found"),rx=d("Extraction_plugin.Modutil.RemainingImplicit"),r8=d('failwith "AXIOM TO BE REALIZED"'),r9=d(U),r$=[0,d(cg),249,8],r_=d("lazy "),sa=[0,d(cg),kC,8],sb=d(k8),sc=d("Lazy.force"),sd=d(ko),se=d(k5),sf=d(gG),sg=d(gN),sh=d("assert false"),si=d(aj),sm=d(U),sj=d(gG),sk=d(gN),sl=d(U),sn=d(kD),sq=[0,d(cg),la,8],so=d(ch),sp=d(c$),st=[0,d(cg),311,8],sr=d(ch),ss=d(c$),su=d(au),sv=d(kD),sy=d(eq),sx=d(ai),sw=d(lf),sz=d("{ "),sA=d(bp),sB=d(eu),sC=d(ev),sD=d("else "),sE=d("then "),sF=d("if "),sG=d(eD),sH=d(gW),sM=d(" = function"),sK=d(ko),sL=d(" = match "),sI=d(a3),sJ=d(ai),sO=d(eo),sN=d(gK),sP=d(kP),tA=d(ld),tB=d("include module type of struct include "),tC=d(c7),tD=d(" : sig"),tE=d(bJ),tF=d(ld),tG=d("module type of struct include "),tH=d(ez),tI=d(bJ),tJ=d(ez),tK=d(bJ),tL=d(ao),tM=d(ew),tN=d(ai),tO=d(ew),tP=d(k_),tQ=d(kQ),tR=d(kM),tS=d(c7),tU=d(W),tT=d(en),tV=d(" with type "),tW=d(ao),tX=d(" with module "),tY=d(ao),tZ=d("include "),t0=d(c7),t1=d(" = struct"),t2=d(bJ),t3=d(k3),t4=d(ao),t5=d(bJ),t6=d(ai),t7=d(bJ),t8=d(ao),t9=d(ew),t_=d(ai),t$=d(ew),ua=d(k_),ub=d(kQ),uc=d(kM),ud=d(c7),uf=d(W),ue=d(kt),ug=d(ch),uh=d(c$),tx=d(ai),tw=d(lj),tu=d(ai),tv=d(bm),ty=d(ez),tz=d("val "),tr=d(ai),to=d(lj),tq=d(ai),tp=d(bm),ts=d(ao),tt=d(gQ),tk=d(U),tn=d(aj),tl=d(bm),tm=d(eo),tg=d(eo),th=d(" Lazy.t"),ti=d(U),tj=d(ao),td=d(eq),tc=d(" : "),tb=d(lf),te=d(" = { "),tf=d(bm),s_=d(lb),s$=d(ai),ta=d(bm),s8=d(kU),s9=d(k0),s3=d("* "),s5=d(" of "),s4=d(gW),s6=d(" unit (* empty inductive *)"),s7=d(ai),s0=d(ao),s1=d(au),s2=d(ao),sZ=d(eB),sW=d(ao),sX=d(kP),sY=d(eo),sS=d(" **)"),sT=d(ez),sU=d("(** val "),sQ=[0,0,0],sR=[0,0,-100000],r3=d(eu),r4=d(ev),rW=d(U),rY=d(kx),rZ=d(en),r0=d(k6),r1=d("'a"),r2=d(U),rX=[0,d(cg),162,36],rV=d(U),rU=[0,d(cg),147,9],rO=d("let __ = let rec f _ = Obj.repr f in Obj.repr f"),rN=d("type __ = Obj.t"),rL=d(gG),rM=d(gN),rK=d("open "),rE=d(ai),rF=d(gQ),rG=d(es),rC=d(W),rB=d(eD),rD=d("fun "),rz=d(gM),rI=c5([d("and"),d(kO),d("assert"),d("begin"),d(kr),d("constraint"),d(li),d("done"),d("downto"),d(kX),d(c7),d("exception"),d("external"),d(ev),d(ks),d("fun"),d("function"),d("functor"),d(k4),d(es),d("include"),d("inherit"),d("initializer"),d("lazy"),d(gD),d(kW),d("method"),d(gT),d("mutable"),d("new"),d("object"),d(ll),d("open"),d("or"),d("parser"),d("private"),d("rec"),d(en),d(kt),d(le),d("to"),d(eu),d("try"),d(eA),d("val"),d("virtual"),d("when"),d("while"),d("with"),d("mod"),d("land"),d("lor"),d("lxor"),d("lsl"),d("lsr"),d("asr"),d(kv),d(bp),d(U)]),rR=c5([61,60,62,64,94,59,38,43,45,42,47,36,37]),rS=c5([33,36,37,38,42,43,45,46,47,58,60,61,62,63,64,94,124,gR]),rT=[0,d("::"),[0,d(ci),0]],uj=[0,d(".mli")],uk=d(gP),uH=d("type:unknown"),uI=d(u),uJ=d("type:axiom"),uK=d(u),uL=d("right"),uM=d("left"),uN=d("type:arrow"),uO=d(u),uP=d(gI),uQ=d(X),uR=d("type:glob"),uS=d(u),uW=d(X),uX=d("type:var"),uY=d(u),uT=d(X),uU=d("type:varidx"),uV=d(u),u0=d("type:dummy"),u1=d(u),uZ=[0,d(kN),66,25],vx=d(c_),vy=d(X),vz=d("fix:item"),vA=d(u),u2=d("expr:axiom"),u3=d(u),u4=d(X),u5=d("expr:rel"),u6=d(u),u7=d(gI),u8=d("func"),u9=d("expr:apply"),u_=d(u),u$=d(c_),va=d(c6),vb=d(k$),vc=d(u),vd=d(c_),ve=d("nameval"),vf=d(X),vg=d("expr:let"),vh=d(u),vi=d(X),vj=d("expr:global"),vk=d(u),vl=d(gI),vm=d(X),vn=d("expr:constructor"),vo=d(u),vp=d(kI),vq=d("expr:tuple"),vr=d(u),vs=d("cases"),vt=d("expr"),vu=d("expr:case"),vv=d(u),vw=d(ks),vB=d("funcs"),vC=d("expr:fix"),vD=d(u),vE=d("msg"),vF=d("expr:exception"),vG=d(u),vH=d("expr:dummy"),vI=d(u),vJ=d(ey),vK=d("expr:coerce"),vL=d(u),vM=d("int"),vN=d("expr:int"),vO=d(u),vP=d("float"),vQ=d("expr:float"),vR=d(u),vS=d(c_),vT=d("pat"),vU=d(kF),vV=d(u),vW=d("pat:wild"),vX=d(u),vY=d(kI),vZ=d("pat:tuple"),v0=d(u),v1=d(X),v2=d("pat:rel"),v3=d(u),v4=d(c6),v5=d(X),v6=d("pat:constructor"),v7=d(u),v8=d(c_),v9=d(c6),v_=d(k$),v$=d(u),wA=[0,d(kN),257,29],wC=d(db),wD=d("  ]"),wE=d("    "),wF=d(": ["),wG=d("declarations"),wH=d(a3),wI=d(ci),ws=d(ey),wt=d(eA),wu=d(X),wv=d("fixgroup:item"),ww=d(u),wh=d(aj),wi=d(ey),wj=d(c6),wk=d(X),wl=d("decl:type"),wm=d(u),wn=d(ey),wo=d(eA),wp=d(X),wq=d("decl:term"),wr=d(u),wx=d("fixlist"),wy=d("decl:fixgroup"),wz=d(u),wa=d("argtypes"),wb=d(X),wc=d("constructors"),wd=d(c6),we=d(X),wf=d("decl:ind"),wg=d(u),uz=d("used_modules"),uA=d("need_dummy"),uB=d("need_magic"),uC=d(X),uD=d(gT),uE=d(u),uF=d(" */"),uG=d("/* "),uv=d(et),uw=d(a3),ux=d(ex),us=d(et),ut=d(a3),uu=d(ex),ur=d(db),up=d(a3),uq=d("{"),uo=d(k3),ul=d(eu),um=d(ev),wL=d(".json"),xm=d(lh),xn=d("() -- AXIOM TO BE REALIZED"),xo=d(kx),xp=d(en),xq=d(k6),xr=d("a"),xt=d("()"),xs=[0,d(eC),a2,27],xu=d('Prelude.error "AXIOM TO BE REALIZED"'),xv=d(U),xw=d(db),xx=d(ao),xy=d(kq),xz=d(es),xA=[0,d(eC),171,8],xB=[0,d(eC),182,8],xC=d(k8),xD=d(" of {"),xE=d("case "),xF=d("Prelude.error"),xG=d(aj),xI=d(U),xH=d(U),xJ=d(kT),xK=d(kK),xL=d(kE),xM=d(bp),xN=d(eD),xO=d(W),xP=d(db),xQ=d(eq),xT=d(eq),xR=d(gK),xS=d(db),xU=d(kq),xV=d(a3),xW=d(ai),yn=[0,d(eC),378,29],ym=d(eB),yk=d(ao),yl=d(kB),yd=d(W),yh=d(W),yg=d(gC),yc=d("= () -- AXIOM TO BE REALIZED"),yf=d(gC),ye=d(bm),yi=d(ao),yj=d(kB),x8=d(W),x$=d(gW),x4=d(W),x5=d(W),x6=d(" () -- empty inductive"),ya=d(a3),yb=d(W),x7=d(ai),x9=d(bm),x_=d("data "),x0=d(lb),x1=d(gC),x3=d(W),x2=d(bm),xX=d(kU),xY=d(k0),xk=d(W),xj=d(eD),xl=d("\\"),wT=d("import qualified "),wU=d('__ = Prelude.error "Logical or arity value used"'),wV=d("__ :: any"),wW=d(gH),wX=d("type Any = ()"),wY=d(gU),wZ=d(gX),w0=d("type Any = GHC.Base.Any"),w1=d(gL),w2=d(gH),w3=d("unsafeCoerce = IOExts.unsafeCoerce"),w4=d(kH),w5=d(gU),w6=d(gX),w7=d("unsafeCoerce = GHC.Base.unsafeCoerce#"),w8=d(kH),w9=d(gL),w_=d(gH),w$=d("import qualified IOExts"),xa=d(gU),xb=d(gX),xc=d("import qualified GHC.Base"),xd=d(gL),xe=d("import qualified Prelude"),xf=d(" where"),xg=d(bJ),xh=d('{- For Hugs, use the option -F"cpp -P -traditional" -}'),xi=d("{-# OPTIONS_GHC -cpp -XMagicHash #-}"),wQ=d(" -}"),wR=d("{- "),wP=d("-- "),wN=c5([d(lh),d(kF),d(kr),d("data"),d("default"),d("deriving"),d(li),d(kX),d(k4),d("import"),d(es),d("infix"),d("infixl"),d("infixr"),d("instance"),d(gD),d(gT),d("newtype"),d(ll),d(le),d(eA),d("where"),d(bp),d(U),d(kO),d("qualified"),d("hiding"),d(kv),d(kT)]),yr=d(".hs"),yw=[0,1],yy=[0,0,0],yz=[0,1],yB=[5,1],yD=[0,d(M),ku,58],yC=[0,d(M),350,27],yE=[0,d(M),la,26],yF=[5,0],yH=[0,d(M),kC,8],yG=[5,0],yI=[0,d(M),268,19],yK=[0,d(M),lk,17],yL=[0,d(M),507,8],yP=[0,d(M),694,33],yQ=[0,d(M),692,15],yR=[0,d(M),693,17],yS=[0,d(M),724,11],yT=[0,[10,1],0],yU=[0,d(M),820,15],yV=[0,d(M),805,2],yY=[5,1],yX=[0,1],y2=[0,d(M),847,2],yW=[9,d("absurd case")],yZ=[0,d(M),860,8],y1=[0,d(M),892,10],y0=[0,d(M),894,10],zd=[0,[10,1],[5,1]],zc=[0,[10,0],[5,0]],zb=[5,1],za=[0,[5,0]],y_=[5,1],y$=[10,1],y9=[5,0],y7=[0,d(M),1069,85],y8=[0,d(M),1065,12],y6=[0,d(M),1058,32],y3=[5,1],y4=[10,1],ys=d("Extraction_plugin.Extraction.I"),yu=d("Extraction_plugin.Extraction.NotDefault"),zl=[0,d(bq),275,15],zn=[0,d(bq),ku,16],zo=[0,d(bq),412,6],zu=[0,0,0],zW=[0,1],zO=d("This command only works with OCaml extraction"),zP=d(gP),zQ=d("testextraction"),zR=d(ln),zS=d(gP),zT=d(".cmo"),zU=d(".cmi"),zV=d("Extracted code successfully compiled"),zG=d(ln),zH=d("-c"),zI=d("-I"),zJ=d("ocamlc"),zM=d(" failed with exit code "),zN=d(k9),zE=d(" failed with error "),zF=d(k9),zC=[0,1],zA=[0,d(bq),705,32],zz=[0,d(bq),691,11],zy=[0,0,0],zx=d("(** User defined extraction *)"),zw=[0,d(bq),664,9],zv=[0,d(bq),641,11],zt=d("[ \t\n]+"),zr=d("Extraction: provided filename is not a valid identifier"),zi=[0,d(bq),gY,18],ze=d("No extraction of toplevel Include yet."),zf=d("CONSTANT"),zg=d("INDUCTIVE"),zj=d("Extraction_plugin.Extract_env.Impossible"),zp=d("Main"),Av=d('The spelling "OCaml" should be used instead of "Ocaml".'),Aq=d(kV),Ar=d(kL),As=d(lc),At=d(kz),Ab=d("mlname"),Ao=d("int_or_id"),Aw=d("deprecated"),Ax=d("deprecated-ocaml-spelling"),AA=d("Ocaml"),AD=d(kV),AG=d(kL),AJ=d(lc),AM=d(kz),AP=d("language"),AU=d("TestCompile"),AV=d(C),A0=d(C),A4=d(C),A5=d(kS),A9=d(C),Bb=d(C),Bf=d(C),Bg=d("Separate"),Bk=d("SeparateExtraction"),Bo=d(kp),Bp=d(C),Bt=d("ExtractionLibrary"),Bx=d(kp),By=d(C),Bz=d(kS),BD=d("RecursiveExtractionLibrary"),BH=d("Language"),BI=d(C),BM=d("ExtractionLanguage"),BQ=d(gF),BR=d(C),BV=d("ExtractionInline"),BZ=d("NoInline"),B0=d(C),B4=d("ExtractionNoInline"),B7=[0,d(k7),[0,d(C),[0,d(gF),0]]],B$=d("PrintExtractionInline"),Cc=[0,d(kY),[0,d(C),[0,d(gF),0]]],Cg=d("ResetExtractionInline"),Ck=[0,d(et),0],Cl=d(ex),Cn=d("Implicit"),Co=d(C),Cs=d("ExtractionImplicit"),Cw=d(gE),Cx=d(C),CB=d("ExtractionBlacklist"),CE=[0,d(k7),[0,d(C),[0,d(gE),0]]],CI=d("PrintExtractionBlacklist"),CL=[0,d(kY),[0,d(C),[0,d(gE),0]]],CP=d("ResetExtractionBlacklist"),CT=d(gO),CW=d(kJ),CX=d(gJ),C1=d("ExtractionConstant"),C5=d(gO),C7=d(kJ),C8=d("Inlined"),C9=d(gJ),Db=d("ExtractionInlinedConstant"),Df=d(et),Dh=d(ex),Dj=d(gO),Dl=d("Inductive"),Dm=d(gJ),Dq=d("ExtractionInductive"),Dt=[0,d("Show"),[0,d(C),0]],Dx=d("ShowExtraction");function
...
dv=[bo,oU,bk(0)],q=[bo,oV,bk(0)],a7=b(f[1][6],oW),bT=b(f[1][6],oX),h1=[0,a7];function
bv(b){if(b){var
...
m=fm(k,h);else{var
n=Y(h),u=a(e[22][c9],l,i),g=n[1],f=0,c=1,d=u,o=n[2];for(;;){if(d){var
j=d[1];if(j){var
...
Q=dd(h),i=a(e[22][c9],Q,d),x=fJ(q,i);if(fI(h,x)){if(3===x[1])var
...
7:var
ad=h[3];if(g){var
ae=g[2],k=a(n[bl][5],g[1],ad),g=ae;continue}throw[0,l,yI];case
9:var
...
k=a(n[bl][1],p,A[2]);continue;case
1:var
...
p=bG(d,c,j),q=b(js(g(aD[64],d,c,p)[1]),d),r=a(e[22][53],1,f),s=a(e[22][14],n[10],r);return aE(q,c,k,0,a(n[bl][1],f,j),s)}}function
cS(d,c){var
...
8:var
c=a[4];continue;default:return 0}}},af=O(i(F[5],0)[1]),Q=a(e[22][c9],g[6],af),ag=b(e[22][1],x);if(b(e[22][1],Q)!==ag)throw[0,l,yL];var
...
O=a(e[5],d,c),P=a(j[6],0,O),A=a(e[22][kR],P,s),B=a(e[22][68],ar,A),C=ar(0),p=bx([0,z,a8([0,B,C])]),n=bx([0,C,F]),q=function(d){if(0===o[1])return aG(p,b(e[22][5],d));var
c=cy(z)[2];if(typeof
...
U=a(e[4],c,m),r=a(e[5],U,d),E=a(e[22][kR],r,f),V=cD(r,E),W=function(a){return x(r,a)},X=a(e[22][68],W,D);return aG(n,bW(q(a(e[23],X,V)),E))}throw[0,l,yV]}function
yN(d,p,E,D,c,h){var
...
B=a(e[5],z,l),C=a(e[22][c9],l,k),L=cD(B,C);function
...
R=k[2],S=k[1],T=b(n[bl][1],1),U=[0,A,S,s,cO(y,a(e[22][68],T,R))],q=b(n[22],U),k=0;continue}var
...
8:var
D=d[4],E=d[3],F=d[2],G=a(aP[3],bv,d[1]),Z=[1,a(aP[3],f[2][1],G),F,E],H=a(n[eE],Z,c),_=b(n[bl][1],1),I=a(e[22][68],_,k);try{f_(c,h,E);var
...
k(d,c,b){return[0,c,a(n[bl][1],d,b)]}var
...
m=a(e[22][68],l,k),f=a(n[93],c,h),o=f[2],p=f[1],b=a(e[5],d,j),q=a(e[22][gV],b,m),s=a(e[23],q,p),t=a(e[22][53],1,b),u=a(e[22][14],n[10],t);return[0,s,cO(a(n[bl][1],b,o),u)]}function
...
y=i(k,c)[1+c],z=i(s,c)[1+c],A=a(n[bl][4],t,z),r=jE(j,h,i(d,c)[1+c],A,y),B=r[2],C=r[1];i(o,c)[1+c]=C;i(l,c)[1+c]=B}catch(a){a=m(a);if(a[1]!==aY[29])throw a;var
...
G=b(n[k1],c),m=g(e[24][33],G,D,A);if(m)var
H=b(n[k1],c),w=g(e[24][33],H,C,z),k=1;else
var
o=m,k=0}else
var
o=l,k=0;if(!k)var
...
c=b[1];return 0===b[2][0]?a(f[8][1],y,c):0},A=a(e[22][kZ],z,w)[1],B=r(aZ[10],d,A,E,c),s=gm(c,d,[0,0,i]),F=b(bf[17],c),t=jJ(B,F,b(n[9],D));if(t){var
...
jY(h,d){if(h)var
i=function(a){return 0},k=function(c,b,a){return 0},c=a(a0[kZ],k,i);else
var
