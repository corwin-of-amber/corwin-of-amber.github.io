parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if(u&&"string"==typeof t)return u(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]);"object"==typeof exports&&"undefined"!=typeof module?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):n&&(this[n]=l)}if(parcelRequire=f,i)throw i;return f}({"Dllb":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.PackageIndex=void 0;class e{constructor(){this.pkgs={},this.loaded=[],this.futures={},this.moduleIndex=new Map,this.directory=["init","coq-base","coq-collections","coq-arith","coq-reals"]}attach(e){return this.worker=e,e.addEventListener("message",e=>this.handleEvent(e)),this}populate(){return Promise.all(this.directory.map(async e=>{var s=await(await fetch(`../bin/coq/${e}.json`)).json();this.pkgs[e]=s;for(let t in s.modules||{})this.moduleIndex.set(t,s)}))}alldeps(e){return t(new Set(e),e=>{let s=this.moduleIndex.get(e),t=(s&&s.modules||{})[e];return t&&t.deps||[]})}async loadModuleDeps(e){var s=new Set;for(let t of this.alldeps(e))s.add(this.moduleIndex.get(t).name);return this.loadPkgs(this.directory.filter(e=>s.has(e)))}loadPkgs(e){e=e.filter(e=>!this.loaded.includes(e));var t=[],r=e.map(e=>(this.futures[e]||(this.futures[e]=new s,t.push(e)),this.futures[e].promise));return this.worker.postMessage(["LoadPkg",t.map(e=>`+${e}`)]),Promise.all(r)}findModule(e,s){e=e?e+".":"";var t="."+s;for(let r of this.moduleIndex.keys())if(r.startsWith(e)&&(r==s||r.endsWith(t)))return r}findModules(e,s){return s.map(s=>this.findModule(e,s)).filter(e=>e)}handleEvent(e){if("LibProgress"===e.data[0]){var s=e.data[1];if(s.done){var t=s.uri.replace(/^([+]|.*[/])/,"").replace(/[.][^.]*$/,"");this.loaded.push(t),this.futures[t]&&this.futures[t].resolve()}}}}exports.PackageIndex=e;class s{constructor(){this.promise=new Promise((e,s)=>{this._resolve=e,this._reject=s}),this._done=!1,this._success=!1}resolve(e){this._done||(this._done=this._success=!0,this._resolve(e))}reject(e){this._done||(this._done=!0,this._reject(e))}isDone(){return this._done}isSuccessful(){return this._success}isFailed(){return this._done&&!this._success}}function t(e,s){for(var t=[...e];t.length>0;){var r=t.shift();for(let i of s(r))e.has(i)||(e.add(i),t.push(i))}return e}
},{}],"djD8":[function(require,module,exports) {
