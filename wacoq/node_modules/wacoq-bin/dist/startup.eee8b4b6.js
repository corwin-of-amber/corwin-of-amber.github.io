...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.InteractiveConsole=void 0;var e=require("events"),t=s(require("jquery")),r=require("./format-pprint");function s(e){return e&&e.__esModule?e:{default:e}}class o extends e.EventEmitter{constructor(){super(),this.console=(0,t.default)("#console"),this.prompt=(0,t.default)("#prompt"),this.progress={},this.pprint=new r.FormatPrettyPrint,this.prompt.keydown(e=>{"Enter"===e.key&&(this.emit("data",this.prompt.val()),this.prompt.val(""))}),this.console.find(".side-note a").click(e=>{e.preventDefault(),(0,t.default)(e.target).closest(".side-note").remove(),this.emit("load-pkg",{uri:"/bin/coq/coq-all.coq-pkg"})})}write(e){var r=(0,t.default)("<div>");return"string"==typeof e?r.addClass("plain").text(e):r.addClass("pp").append(...this.pprint.pp2DOM(e)),r.insertBefore(this.prompt),r}writeGoals(e){var r=(0,t.default)("<div>");return r.append(this.pprint.goals2DOM(e)),r.insertBefore(this.prompt),r}showProgress(e,r,s){var o=this.progress[e];if(r.done)o&&(o.remove(),delete this.progress[e]);else if(r.download&&o){if(r.download.total){var i=r.download.downloaded/r.download.total,p=o.find("span.percent");0==p.length&&o.append(p=(0,t.default)("<span>").addClass("percent")),p.text(`${(100*i).toFixed(1)}%`)}}else this.progress[e]=this.write(s||`${e}...`)}}exports.InteractiveConsole=o;
},{"events":"djD8","jquery":"juYr","./format-pprint":"sSM6"}],"LSRl":[function(require,module,exports) {
"use strict";var a=require("./ui/console");function e(){var e=+new Date,t=()=>+new Date-e;function n(a){console.log(`%c${a} (+${t()}ms)`,"color: #99f")}var o=new Worker("./worker.js");function s(a){o.postMessage(JSON.stringify(a))}var r=new a.InteractiveConsole;o.addEventListener("message",a=>{switch(console.log(a.data),a.data[0]){case"Starting":n("Starting"),r.showProgress("Starting",{done:!1});break;case"Boot":n("Boot"),s(["Init",{}]);break;case"Ready":n("Ready"),r.showProgress("Starting",{done:!0}),s(["Add",null,null,"Check nat.",!0]);break;case"Added":s(["Exec",a.data[1]]),s(["Goals",a.data[1]]);break;case"GoalInfo":a.data[2]&&r.writeGoals(a.data[2]);break;case"CoqExn":a.data[3]&&r.write(a.data[3]);break;case"Feedback":"Message"===a.data[1].contents[0]&&r.write(a.data[1].contents[3]);break;case"LibProgress":var e=a.data[1];e.content.uri&&r.showProgress(e.content.uri,e,`Downloading ${e.content.uri}...`)}}),r.on("data",a=>s(["Add",null,null,a,!0])),r.on("load-pkg",a=>o.postMessage(["LoadPkg",a.uri])),Object.assign(window,{worker:o})}Object.assign(window,{main:e});
},{"./ui/console":"ZTyF"}]},{},["LSRl"], null)