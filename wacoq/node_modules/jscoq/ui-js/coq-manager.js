...
class CoqManager {
    ...
    async launch() {
        try {
            ...
            var pkg_path = new URL(`${this.options.node_modules_path}/coq-wasm/bin/coq`
                                   .replace('//', '/'), location).href;
            this.packages.addBundleInfo('init', {desc: 'init', pkgs: [], archive: `${pkg_path}/dist-init.zip`});
            this.packages.addBundleInfo('coq-all', {desc: 'coq-all', pkgs: [], archive: `${pkg_path}/dist-full.zip`});
        }
        catch (err) {
