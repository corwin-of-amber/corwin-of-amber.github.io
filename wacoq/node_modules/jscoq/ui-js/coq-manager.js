    ...
    async launch() {
        try {
            ...
            */
            ...
            this.packages.initializePackageList({'-': ['init', 'coq-all', 'mathcomp']});

            var pkg_path = new URL('../bin/coq', CoqWorker.defaultScriptPath()).href;
            this.packages.addBundleInfo('init', {desc: 'init', deps: [],
                archive: `${pkg_path}/init.coq-pkg`});
            this.packages.addBundleInfo('coq-all', {desc: 'coq-all', deps: ['init'],
                archive: `${pkg_path}/coq-all.coq-pkg`});
            this.packages.addBundleInfo('mathcomp', {desc: 'mathcomp', deps: ['coq-all'],
                archive: `${pkg_path}/mathcomp.coq-pkg`});
        }
        catch (err) {
