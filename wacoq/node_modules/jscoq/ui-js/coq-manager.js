...
class CoqManager {
    ...
    async launch() {
        try {
            ...
            this.packages.addBundleInfo('init', {desc: 'init', pkgs: [], archive: '/node_modules/coq-wasm/bin/coq/dist-init.zip'});
            this.packages.addBundleInfo('coq-all', {desc: 'coq-all', pkgs: [], archive: '/node_modules/coq-wasm/bin/coq/dist-full.zip'});
        }
        catch (err) {
